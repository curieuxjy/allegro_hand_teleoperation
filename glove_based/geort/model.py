...
class FKModel(nn.Module):
    def __init__(self, keypoint_joints):
        ...
        # TODO! Important! the order of nets
        # print("FKModel")
        # Reflect keypoint_joints order
        # keypoint_joints [[8, 9, 10, 11], [4, 5, 6, 7], [0, 1, 2, 3], [12, 13, 14, 15]]
...
class IKModel(nn.Module):
    def __init__(self, keypoint_joints):
        ...
        # print("IKModel") # TODO!! Verify nets order in IKModel
        # Verify keypoint_joints order
